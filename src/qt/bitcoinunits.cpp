...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(AFO);
    unitlist.append(mAFO);
    unitlist.append(uAFO);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    ...
    case AFO:
        return QString("afox");
    case mAFO:
        return QString("mafox");
    case uAFO:
        return QString::fromUtf8("uafox");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZafo)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZAFO)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZAFO);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZAFO)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZAFO));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
