    ...
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableAFO,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableAFO,
    ...
    connect(ui->pushButton_UnspendableAFO, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableAFO);});
